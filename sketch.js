...
function setup() {
  ...
  ground = createSprite(width/4,height-10,width,125);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(width,height-200,width,height-10);
    cloud.y = Math.round(random(80,height-10));
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(width,height-25,width,height-10);
    //obstacle.debug = true;
